import views.windowView as window
...
class ItemController:
    ...
    def new_item(self, name: str, description: str, htva_price: float, tva_tare: str):
            ...
            if name != "" and htva_price != "" and tva_tare != "":
                ...
                window.Window.show_message_success("L'article a bien été enregistré.")
            else:
                window.Window.show_message_failure("Veuillez remplire les données")
    ...
    def modif_item(
        ...
        if name != "" and htva_price != "" and tva_tare != "":
            ...
            window.Window.show_message_success("L'article a bien été modifier.")
        else:
            window.Window.show_message_failure("Veuillez remplire les données")
    ...
    def delete_item(self,id_item):
        ...
        if id_item != "":
            ...
            window.Window.show_message_success("L'article a bien été supprimé.")
        else:
            window.Window.show_message_failure("Veuillez remplire les données")
